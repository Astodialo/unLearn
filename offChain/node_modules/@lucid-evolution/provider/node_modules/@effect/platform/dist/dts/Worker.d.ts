 ...
 * @category constructors
 */
export declare const makeSerialized: <I extends Schema.TaggedRequest.Any>(options: SerializedWorker.Options<I>) => Effect.Effect<SerializedWorker<I>, WorkerError, WorkerManager | Spawner | Scope.Scope>;
/**
 * @since 1.0.0
 * @category constructors
 */
export declare const makePoolSerialized: <I extends Schema.TaggedRequest.Any>(options: SerializedWorkerPool.Options<I>) => Effect.Effect<SerializedWorkerPool<I>, WorkerError, WorkerManager | Spawner | Scope.Scope>;
/**
 * @since 1.0.0
 * @category layers
 */
export declare const makePoolSerializedLayer: <Tag, I extends Schema.TaggedRequest.Any>(tag: Context.Tag<Tag, SerializedWorkerPool<I>>, options: SerializedWorkerPool.Options<I>) => Layer.Layer<Tag, WorkerError, WorkerManager | Spawner>;
/**
 * @since 1.0.0
 * @category layers
 */
