...
export interface BackingRunner<I, O> {
    readonly run: <A, E, R>(handler: (portId: number, message: I) => Effect.Effect<A, E, R>) => Effect.Effect<never, E | WorkerError, R>;
 ...
 * @category constructors
 */
export declare const makeSerialized: <R, I, A extends Schema.TaggedRequest.Any, const Handlers extends SerializedRunner.Handlers<A>>(schema: Schema.Schema<A, I, R>, handlers: Handlers) => Effect.Effect<void, WorkerError, PlatformRunner | Scope.Scope | R | SerializedRunner.HandlersContext<Handlers>>;
/**
 * @since 1.0.0
 * @category layers
 */
export declare const layerSerialized: <R, I, A extends Schema.TaggedRequest.Any, const Handlers extends SerializedRunner.Handlers<A>>(schema: Schema.Schema<A, I, R>, handlers: Handlers) => Layer.Layer<never, WorkerError, PlatformRunner | R | SerializedRunner.HandlersContext<Handlers>>;
