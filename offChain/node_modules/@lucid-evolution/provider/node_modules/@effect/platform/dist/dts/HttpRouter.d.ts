 ...
 * @category route context
 */
export declare const schemaParams: <A, I extends Readonly<Record<string, string | Array<string> | undefined>>, R>(schema: Schema.Schema<A, I, R>, options?: ParseOptions | undefined) => Effect.Effect<A, ParseResult.ParseError, R | RouteContext | ServerRequest.ParsedSearchParams>;
/**
 * @since 1.0.0
 * @category route context
 */
