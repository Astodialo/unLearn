...
*/
export function hash_script_data(redeemers: Redeemers, cost_models: CostModels, datums?: PlutusDataList): ScriptDataHash;
/**
...
* @returns {GovAction}
*/
  static new_treasury_withdrawals_action(withdrawal: MapRewardAccountToCoin, policy_hash?: ScriptHash): GovAction;
/**
* @param {GovActionId | undefined} [action_id]
* @returns {GovAction}
*/
...
* @returns {GovAction}
*/
  static new_update_committee(action_id: GovActionId | undefined, cold_credentials: CommitteeColdCredentialList, credentials: MapCommitteeColdCredentialToEpoch, unit_interval: UnitInterval): GovAction;
/**
* @param {GovActionId | undefined} action_id
...
* @returns {ResignCommitteeColdCert}
*/
  static new(committee_cold_credential: Credential, anchor?: Anchor): ResignCommitteeColdCert;
}
/**
*/
...
* @returns {TreasuryWithdrawalsAction}
*/
  static new(withdrawal: MapRewardAccountToCoin, policy_hash?: ScriptHash): TreasuryWithdrawalsAction;
}
/**
*/
...
* @returns {UpdateCommittee}
*/
  static new(action_id: GovActionId | undefined, cold_credentials: CommitteeColdCredentialList, credentials: MapCommitteeColdCredentialToEpoch, unit_interval: UnitInterval): UpdateCommittee;
}
/**
*/
...
* @returns {VotingProcedure}
*/
  static new(vote: Vote, anchor?: Anchor): VotingProcedure;
}
/**
*/
