...
import { ProjPointType as PointType, VerOpts } from './abstract/weierstrass.js';
...
export declare const secp256k1: Readonly<{
    ...
    verify: (signature: Hex | {
        r: bigint;
        s: bigint;
    }, msgHash: Hex, publicKey: Hex, opts?: VerOpts | undefined) => boolean;
...
export declare const secp256k1PointToBytes: (point: PointType<bigint>) => Uint8Array;
export declare const Secp256k1Point: import("./abstract/weierstrass.js").ProjConstructor<bigint>;
/**
...
export declare const signSchnorr: typeof schnorrSign;
export declare const verifySchnorr: typeof schnorrVerify;
...
export declare function signSecp256k1(data: Uint8Array, privateKey: Uint8Array, extraEntropy?: Uint8Array | undefined): Uint8Array;
export declare function verifySecp256k1(sig: Uint8Array, msgHash: Uint8Array, pubKey: Uint8Array): boolean;
export {};
