...
export declare const shrSH: (h: number, _l: number, s: number) => number;
...
export declare const rotr32H: (_h: number, l: number) => number;
export declare const rotr32L: (h: number, _l: number) => number;
