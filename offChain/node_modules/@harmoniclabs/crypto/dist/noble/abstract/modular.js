...
var isNegativeLE = function (num, modulo) { return (mod(num, modulo) & _1n) === _1n; };
...
function Field(ORDER, bitLen, isLE, redef) {
    if (isLE === void 0) { isLE = false; }
    if (redef === void 0) { redef = {}; }
    if (ORDER <= _0n)
    ...
    var f = Object.freeze({
        ...
        ZERO: _0n,
        ONE: _1n,
        create: function (num) { return mod(num, ORDER); },
        isValid: function (num) {
            if (typeof num !== 'bigint')
                throw new Error("Invalid field element: expected bigint, got ".concat(typeof num));
            return _0n <= num && num < ORDER; // 0 is valid element, but it's not invertible
        },
        is0: function (num) { return num === _0n; },
        isOdd: function (num) { return (num & _1n) === _1n; },
        neg: function (num) { return mod(-num, ORDER); },
        eql: function (lhs, rhs) { return lhs === rhs; },
        sqr: function (num) { return mod(num * num, ORDER); },
        add: function (lhs, rhs) { return mod(lhs + rhs, ORDER); },
        sub: function (lhs, rhs) { return mod(lhs - rhs, ORDER); },
        mul: function (lhs, rhs) { return mod(lhs * rhs, ORDER); },
        pow: function (num, power) { return FpPow(f, num, power); },
        div: function (lhs, rhs) { return mod(lhs * invert(rhs, ORDER), ORDER); },
        // Same as above, but doesn't normalize
        sqrN: function (num) { return num * num; },
        addN: function (lhs, rhs) { return lhs + rhs; },
        subN: function (lhs, rhs) { return lhs - rhs; },
        mulN: function (lhs, rhs) { return lhs * rhs; },
        inv: function (num) { return invert(num, ORDER); },
        sqrt: redef.sqrt || (function (n) { return sqrtP(f, n); }),
        invertBatch: function (lst) { return FpInvertBatch(f, lst); },
        // TODO: do we really need constant cmov?
        // We don't have const-time bigints anyway, so probably will be not very useful
        cmov: function (a, b, c) { return (c ? b : a); },
        toBytes: function (num) { return (isLE ? (0, utils_1.numberToBytesLE)(num, BYTES) : (0, utils_1.numberToBytesBE)(num, BYTES)); },
        fromBytes: function (bytes) {
            if (bytes.length !== BYTES)
                throw new Error("Fp.fromBytes: expected ".concat(BYTES, ", got ").concat(bytes.length));
...
function hashToPrivateScalar(hash, groupOrder, isLE) {
    ...
    if (minLen < 24 || hashLen < minLen || hashLen > 1024)
        throw new Error("hashToPrivateScalar: expected ".concat(minLen, "-1024 bytes of input, got ").concat(hashLen));
