...
export declare const effect: {
     ...
     * @category constructors
     */
    <T extends Context.Tag<any, any>>(tag: T): <E, R>(effect: Effect.Effect<Context.Tag.Service<T>, E, R>) => Layer<Context.Tag.Identifier<T>, E, R>;
    /**
     * Constructs a layer from the specified effect.
     *
     * @since 2.0.0
     * @category constructors
     */
    <T extends Context.Tag<any, any>, E, R>(tag: T, effect: Effect.Effect<Context.Tag.Service<T>, E, R>): Layer<Context.Tag.Identifier<T>, E, R>;
};
/**
...
declare const fromFunction: <A extends Context.Tag<any, any>, B extends Context.Tag<any, any>>(tagA: A, tagB: B, f: (a: Context.Tag.Service<A>) => Context.Tag.Service<B>) => Layer<Context.Tag.Identifier<B>, never, Context.Tag.Identifier<A>>;
export { 
/**
...
export declare const project: {
     ...
     * @category utils
     */
    <A extends Context.Tag<any, any>, B extends Context.Tag<any, any>>(tagA: A, tagB: B, f: (a: Context.Tag.Service<A>) => Context.Tag.Service<B>): <RIn, E>(self: Layer<Context.Tag.Identifier<A>, E, RIn>) => Layer<Context.Tag.Identifier<B>, E, RIn>;
    /**
     * Projects out part of one of the services output by this layer using the
     * specified function.
     *
     ...
     * @category utils
     */
    <RIn, E, A extends Context.Tag<any, any>, B extends Context.Tag<any, any>>(self: Layer<Context.Tag.Identifier<A>, E, RIn>, tagA: A, tagB: B, f: (a: Context.Tag.Service<A>) => Context.Tag.Service<B>): Layer<Context.Tag.Identifier<B>, E, RIn>;
};
/**
 * @since 2.0.0
 * @category utils
...
export declare const retry: {
     ...
     * @category retrying
     */
    <X, E, RIn2>(schedule: Schedule.Schedule<X, E, RIn2>): <ROut, RIn>(self: Layer<ROut, E, RIn>) => Layer<ROut, E, RIn2 | RIn>;
    /**
     * Retries constructing this layer according to the specified schedule.
     *
     * @since 2.0.0
 ...
 * @category constructors
 */
export declare const scope: Layer<Scope.CloseableScope>;
/**
...
export declare const scoped: {
     ...
     * @category constructors
     */
    <T extends Context.Tag<any, any>>(tag: T): <E, R>(effect: Effect.Effect<Context.Tag.Service<T>, E, R>) => Layer<Context.Tag.Identifier<T>, E, Exclude<R, Scope.Scope>>;
    /**
     * Constructs a layer from the specified scoped effect.
     *
     * @since 2.0.0
     * @category constructors
     */
    <T extends Context.Tag<any, any>, E, R>(tag: T, effect: Effect.Effect<Context.Tag.Service<T>, E, R>): Layer<Context.Tag.Identifier<T>, E, Exclude<R, Scope.Scope>>;
};
/**
 * Constructs a layer from the specified scoped effect.
 *
