...
export declare namespace ManagedRuntime {
     ...
     * @since 3.4.0
     */
    type Context<T extends ManagedRuntime<any, any>> = [T] extends [ManagedRuntime<infer R, infer _E>] ? R : never;
    /**
     * @category type-level
     * @since 3.4.0
     */
    type Error<T extends ManagedRuntime<any, any>> = [T] extends [ManagedRuntime<infer _R, infer E>] ? E : never;
}
/**
 * @since 2.0.0
 * @category models
