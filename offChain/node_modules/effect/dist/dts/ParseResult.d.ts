...
export declare class Composite {
    ...
    constructor(ast: AST.AST, actual: unknown, issues: SingleOrNonEmpty<ParseIssue>, output?: unknown);
}
/**
...
declare const ParseError_base: new <A extends Record<string, any> = {}>(args: import("./Types.js").Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }) => cause_.YieldableError & {
 ...
 * @since 3.10.0
 */
export declare const isComposite: (issue: ParseIssue) => issue is Extract<ParseIssue, {
    _tag: "Composite";
}>;
/**
 * @category model
